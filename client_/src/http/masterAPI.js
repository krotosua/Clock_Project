...
export const fetchMasters = async (cityId, page, limit, sorting, ascending, filters) => {
    return await $host.get('api/masters/', {params: {cityId, page, limit, sorting, ascending, filters}})
}
